...
<footer className="bg-blue-50 dark:bg-gray-800 w-full py-4">
    <div className="max-w-screen-xl mx-auto px-4">
        <ul className="max-w-screen-md mx-auto text-lg font-light flex flex-wrap justify-between">
            <li className="my-2">
                <a className="text-gray-800 hover:text-gray-800 dark:text-gray-300 dark:hover:text-white transition-colors duration-200" href="#">
                    FAQ
                </a>
            </li>
            <li className="my-2">
        ...
        <div className="text-center pt-10 sm:pt-12 font-light flex items-center justify-center">
            ...
            <div className="text-center text-gray-800 dark:text-gray-200 pt-10 sm:pt-12 font-light flex items-center justify-center">
                &copy; JustGo - All rights reserved.
            </div>
        </div>
    </footer>
</div>
