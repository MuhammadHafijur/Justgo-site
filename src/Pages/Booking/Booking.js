...
<div class="min-h-screen p-6 bg-gray-100 flex items-center justify-center">
  <div class="container max-w-screen-lg mx-auto">
    ...
    {/* <a href="/" target="_blank" class="md:absolute bottom-0 right-0 p-4 float-right">
      <img src={plane} alt="Buy Me A Coffee" class="bg-gray-800 transition-all rounded-full w-14 -rotate-45 hover:shadow-sm shadow-lg ring hover:ring-4 ring-white" />
    </a> */}
  </div>
</div>
        </div>
