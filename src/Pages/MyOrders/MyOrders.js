    ...
    <div>
      ...
      {orders.map((order) => (
        <div class="flex" key={order._id}>
          ...
          <h3 className="flex-grow border-2 pl-4 rounded mb-4 mr-2 py-4">{order.service.Name}</h3>
          <h3 className="flex-none border-2 px-4 rounded mb-4 mr-2 py-4">{order.service.Price}</h3>
          <button
