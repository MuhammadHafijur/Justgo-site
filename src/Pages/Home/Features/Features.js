...
<h1 className="text-4xl font-bold text-center text-gray-800 mb-24">FEATURES</h1>
    <div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-12 lg:items-center">
                ...
                <li>
                    <div class="flex">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="mt-2 text-lg leading-6 text-gray-500 dark:text-gray-300">
        ...
        <div class="mt-10 -mx-4 md:-mx-12 relative lg:mt-0 lg:col-start-1">
            <img src="https://i.ibb.co/M1SCTKQ/feature-img.jpg" alt="illustration" class="h-96 w-auto relative mx-auto shadow-lg rounded"/>
        </div>
    </div>
</div>
