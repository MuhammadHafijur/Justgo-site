  ...
  return (
    <div className="w-3/4 mx-auto">
      ...
      {orders.map(order => 
        ...
        <h3 className="flex-initial border-2 p-2 rounded mb-4 mr-2 py-4">{order.userName}</h3>
        <h3 className="flex-1 border-2 pl-4 rounded mb-4 mr-2 py-4">{order.service.Name}</h3>
        <h3 className="flex-1 border-2 pl-4 rounded mb-4 mr-2 py-4">{order.Address}</h3>
        <h3 className="flex-1 border-2 pl-4 rounded mb-4 mr-2 py-4">{order.Number}</h3>
        <h3 className="flex-1 border-2 pl-4 rounded mb-4 mr-2 py-4">{order.Date}</h3>
        <button
